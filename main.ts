...
function Menu () {
    ...
    myMenu.setMenuStyleProperty(miniMenu.MenuStyleProperty.Height, 70)
    myMenu.y = 60
    myMenu.x = 80
    myMenu.setFrame(img`
...
function show_intro () {
    scene.setBackgroundImage(img`
        ...
        `)
    game.showLongText("Hace 537 años, el rey Citrama inició su intento de conquista del mundo, después de pactar con un misterioso hechicero. ", DialogLayout.Bottom)
    game.showLongText("El resto del mundo le hizo frente, y gracias al esfuerzo de todos, el tirano fue derrotado.", DialogLayout.Bottom)
    game.showLongText("A partir de ese momento volvió a reinar la paz, pero nunca se llegó a saber el paradero del instigador...", DialogLayout.Bottom)
    FadeToBlack(3000)
    scene.setBackgroundImage(img`
        ...
        `)
    color.pauseUntilFadeDone()
    game.showLongText("Ahora, después de más de 5 siglos, una nueva amenaza surge", DialogLayout.Bottom)
    game.showLongText("Y tú serás el encargado de detenerla...", DialogLayout.Bottom)
}
