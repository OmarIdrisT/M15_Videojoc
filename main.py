...
def Menu():
    ...
    myMenu = miniMenu.create_menu(miniMenu.create_menu_item("Continuar"),
    ...
    myMenu.set_menu_style_property(miniMenu.MenuStyleProperty.HEIGHT, 70)
    myMenu.y = 60
    myMenu.x = 80
...
def show_intro():
    ...
    """))
    game.show_long_text("1", DialogLayout.BOTTOM)
    game.show_long_text("2", DialogLayout.BOTTOM)
    game.show_long_text("3", DialogLayout.BOTTOM)
    FadeToBlack(3000)
    scene.set_background_image(img("""
    ...
    """))
    color.pause_until_fade_done()
    game.show_long_text("4", DialogLayout.BOTTOM)
    game.show_long_text("5", DialogLayout.BOTTOM)
