    ...
    def on_button_pressed(selection, selectedIndex):
        ...
        if selectedIndex == 0:
            if new_game:
                ...
                game.show_long_text("No hay datos guardados", DialogLayout.BOTTOM)
                menu()
...
def game_intro():
    ...
    """))
    game.show_long_text("Parrafada 1", DialogLayout.BOTTOM)
    game.show_long_text("Parrafada 2", DialogLayout.BOTTOM)
    game.show_long_text("Parrafada 3", DialogLayout.BOTTOM)
    scene.set_background_image(img("""
    ...
    """))
    game.show_long_text("Parrafada 4", DialogLayout.BOTTOM)
    game.show_long_text("Parrafada 5", DialogLayout.BOTTOM)
def generate_main_menu():
    ...
    main_menu = miniMenu.create_menu(miniMenu.create_menu_item("Continuar"),
        miniMenu.create_menu_item("Nueva Partida"),
        miniMenu.create_menu_item("Ajustes"),
        miniMenu.create_menu_item("Volver al título"))
    main_menu.set_menu_style_property(miniMenu.MenuStyleProperty.WIDTH, 110)
    main_menu.set_menu_style_property(miniMenu.MenuStyleProperty.HEIGHT, 70)
    main_menu.set_style_property(miniMenu.StyleKind.DEFAULT_AND_SELECTED,
        miniMenu.StyleProperty.BACKGROUND,
        12)
    main_menu.x = 80
    main_menu.y = 55
    main_menu.set_frame(img("""
